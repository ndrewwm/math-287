...
% \begin{align*}
% 10^{k+1} + 3 \cdot 4^{k+1+2} + 5 &= 10 \cdot 10^k + 12 \cdot 4^{k+2} + 5 \\
...
%                                        &= 10(10^k) + 3(4^3)(4^k) + 5 \\
%                                        &= 10(5 \cdot 2)^k + 3(4^3)(2 \cdot 2)^k + 5 \\
%                                        &= 10^1 \cdot (10^k + 3 \cdot 4^{k + 2}) \cdot 4^1 + 5 \\
%                                        &= 10 \cdot (9y - 5) \cdot 4 + 5 \\
%                                        &= 40(9y - 5) + 5 \\
%                                        &= 360y - 195 \\
%                                        &= 9(40y) - 195
% \end{align*}
%
% i.e., $10^k + 3 \cdot 4^{k+2} + 5 = 9y$ where $y \in \bfZ$. We will now attempt to show that $P(k + 1)$ is true:
% \begin{align*}
% 10^{k + 1} + 3 \cdot 4^{k + 1 + 2} + 5 &= 10^{k + 1} + 3 \cdot 4^{k + 2 + 1} + 5 \\
%                                        &= 10^1 \cdot 10^k + 3 \cdot 4^{k + 2} \cdot 4^1 + 5 \\
